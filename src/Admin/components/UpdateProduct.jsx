...
const UpdateProduct = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            setLoading(true);
            await dispatch(findProductsById(productId));
            setLoading(false);
        };
        fetchProduct();
    }, [dispatch, productId]);
    ...
    useEffect(() => {
        if (products.product) {
            setProductData({
                ...
                discountPresent: products.product.discountPresent,
                size: products.product.size || initialSizes,
                quantity: products.product.quantity,
                topLevelCategory: products.product.topLevelCategory,
                secondLevelCategory: products.product.secondLevelCategory,
                thirdLevelCategory: products.product.thirdLevelCategory,
