...
import { LocalMall, LocalMallOutlined, LocalMallSharp, LocalMallTwoTone, ManageAccounts } from "@mui/icons-material";
...
export default function Navigation() {
  ...
  const handleCategoryClick = (category, section, item, closeFunction) => {
    ...
    closeFunction(); // Ensure the function is properly called
  };
  ...
  useEffect(() => {
    ...
    console.log("frontend-dispatch", auth?.user_data);
      ...
      <header className="relative bg-white">
        ...
        >
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  ...
                  <img className="h-8 w-auto" src={logo} onClick={()=>navigate('/')} alt="WEARUS" />
                </a>
              </div>
          ...
          {/* condition for admin profile  */}
                  ...
                  {auth.user_data?.firstName? (
                    <div>

                    {auth.user_data?.role == "ADMIN" ?
                    (
                      <>
                    <Avatar
                      ...
                      ( <>
                        ...
                        >
                            {auth.user_data?.firstName[0].toUpperCase()}
                        </Avatar>
